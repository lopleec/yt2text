...
import type { AudioQuality, CliOptions, OutputFormat, TranscriptDocument, WhisperModel } from "./types.js";
...
async function runPipeline(input: string, inputKind: "url" | "file", options: CliOptions): Promise<void> {
